...
def process_tree_file(tree_path, args, process_seed):
    ...
    try:
        ...
        quarter_spans = get_quarter_generations(total_gens)
        sampling_schemes = {}

        sampling_scheme_options = {
            'contemporary_fixed': [True, False],
            'n_non_contemporaries': [2, 10, args.noncontemporary_n_max],
            'non_contemporary_span': ['last_quarter', 'last_half', 'last_three_quarters']
        }
        ...
        for contemporary_fixed, n_non_contemporaries, span in itertools.product(
            ...
            span_generations = quarter_spans[span]
            ...
            # Get the individual IDs for our sampled pedigree IDs (very fast lookup)
